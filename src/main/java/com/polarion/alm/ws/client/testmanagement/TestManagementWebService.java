...
public interface TestManagementWebService extends java.rmi.Remote {
    ...
    /**
     * Adds specified Project to project span of the Test Run.
     * @param uri URI of the Test Run (not null)
     * @param projectId project ID of the project to be added(not null)
     * @since 3.10.1
     */
     ...
     * @param project project the test run will be created in. 
     * @param id id of the test run to be created.
     * @param title title of the test run to be created. Template title is
     * used when null.
     * @param template template to be used to create the test run.
     * @return URI of the created test run.
     * @since 3.10.1
    ...
    /**
     * Removes specified Project to project span of the Test Run.
     * @param uri URI of the Test Run (not null)
     * @param projectId project ID of the project to be remove(not null)
     * @since 3.10.1
     */
