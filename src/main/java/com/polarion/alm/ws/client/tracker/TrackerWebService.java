...
public interface TrackerWebService extends java.rmi.Remote {
     ...
     * @param in0 workitemURI the URI of the work item to add link to.
     * @param in1 linkedWorkitemURI the URI of the target work item the link
     * points to.
     * @param in2 role the role of the linked item to add.
     * @param in3 revision specific revision for linked item (null means
     * HEAD revision)
     * @param in4 suspect true if the link should be marked with suspect
     * flag
     * @since 3.4.3
     */
