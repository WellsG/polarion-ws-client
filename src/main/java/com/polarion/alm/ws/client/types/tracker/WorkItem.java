...
public class WorkItem  implements java.io.Serializable {
    ...
    private com.polarion.alm.ws.client.types.tracker.LinkedOslcResource[] linkedOslcResources;
    ...
    public WorkItem(
           ...
           com.polarion.alm.ws.client.types.tracker.LinkedOslcResource[] linkedOslcResources,
           ...
           this.linkedOslcResources = linkedOslcResources;
     ...
     */
    public com.polarion.alm.ws.client.types.tracker.LinkedOslcResource[] getLinkedOslcResources() {
        return linkedOslcResources;
    }


    /**
     * Sets the linkedOslcResources value for this WorkItem.
     * 
     * @param linkedOslcResources
     */
    public void setLinkedOslcResources(com.polarion.alm.ws.client.types.tracker.LinkedOslcResource[] linkedOslcResources) {
        this.linkedOslcResources = linkedOslcResources;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.linkedOslcResources==null && other.getLinkedOslcResources()==null) || 
             (this.linkedOslcResources!=null &&
              java.util.Arrays.equals(this.linkedOslcResources, other.getLinkedOslcResources()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getLinkedOslcResources() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getLinkedOslcResources());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getLinkedOslcResources(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("linkedOslcResources");
        elemField.setXmlName(new javax.xml.namespace.QName("http://ws.polarion.com/TrackerWebService-types", "linkedOslcResources"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.polarion.com/TrackerWebService-types", "LinkedOslcResource"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ws.polarion.com/TrackerWebService-types", "LinkedOslcResource"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
